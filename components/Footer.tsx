    ...
    <footer className="bg-brand-dark text-white py-16">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10 border-b border-gray-700 pb-10 mb-10">
          <div>
            <h2 className="text-3xl font-serif font-bold tracking-widest mb-2">HAJMARI Design</h2>
          ...
          <div className="flex gap-6">
            ...
            <a href="mailto:info@example.com" className="hover:text-brand-accent transition-colors"><Mail size={24} /></a>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-gray-400">
          ...
          <div className="md:text-right">
            <p>© {new Date().getFullYear()} HAJMARI Design. All Rights Reserved.</p>
          </div>
        </div>
      </div>
    </footer>
